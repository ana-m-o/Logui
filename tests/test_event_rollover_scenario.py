...
def test_non_recurring_events_disappear_after_rollover(tmp_path):
    ...
    all_events_day1 = [ev for ev in repo.list_events() if is_visible_in_events_pane(ev, today=yesterday)]
    ...
    all_events_day2 = [ev for ev in repo.list_events() if is_visible_in_events_pane(ev, today=today)]
